...
- **Resumable, never restart-from-zero.** Per-area commits + an area checklist (`fix_plan.md`) are the checkpoint state; an interrupted sweep resumes from the first unchecked area.
